...
namespace DietApp.Views.SKViews.Base
{
    public abstract class GradientViewBase : SKViewBase
    {
        public static readonly BindableProperty StartColorProperty = BindableProperty.Create(nameof(StartColor), typeof(Color), typeof(GradientViewBase), Color.White);
        public static readonly BindableProperty EndColorProperty = BindableProperty.Create(nameof(EndColor), typeof(Color), typeof(GradientViewBase), Color.White);
