...
namespace DietApp.Services.Helper
{
    public class HelperService : IHelperService
    {
        ...
        public int DailyCalories (IProfileService profileService, IDatabaseService databaseService)
        {
            User user = profileService.GetUserInfo();
            List<string> genders = databaseService.GetGenderOptions();
